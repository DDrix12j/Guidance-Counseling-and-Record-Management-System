...
<body>
    ...
    <div class="container mt-5">
        <a href="about_manage.php" class="btn btn-dark">Go Back</a>
        <form method="post" action="req/about_update.php" enctype="multipart/form-data" class="shadow p-3 mt-5 form-w">
            <h3>Edit Box</h3><hr>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="title" value="<?=$box['title']?>" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Content</label>
                <textarea class="form-control" name="content" rows="5" required><?=$box['content']?></textarea>
            </div>
            <div class="mb-3">
                <label class="form-label">Upload Logo</label>
                <input type="file" class="form-control" name="logo">
                <?php if ($box['logo']) { ?>
                    <img src="../uploads/<?=$box['logo']?>" alt="Logo" width="100">
                    <a href="req/remove_logo.php?id=<?=$box['id']?>" class="btn btn-danger btn-sm">Remove Logo</a>
                <?php } ?>
            </div>
            <div class="mb-3">
                ...
                <?php if ($box['image']) { ?>
                    <img src="../uploads/<?=$box['image']?>" alt="Image" width="100">
                    <a href="req/remove_image.php?id=<?=$box['id']?>" class="btn btn-danger btn-sm">Remove Image</a>
                <?php } ?>
            </div>
