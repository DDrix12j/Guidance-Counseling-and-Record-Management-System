...
function getFilteredStudents($conn, $sort_by, $search_key) {
    $allowed_sort = ['fname', 'lname', 'grade'];
    $sort_by = in_array($sort_by, $allowed_sort) ? $sort_by : 'fname';

    $sql = "SELECT *, class_id FROM students
            WHERE fname LIKE ? OR lname LIKE ? OR lrn LIKE ?
