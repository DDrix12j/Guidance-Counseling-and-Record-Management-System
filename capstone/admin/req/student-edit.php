...
if (isset($_POST['fname'])      &&
    ...
    isset($_POST['class_id'])      && // <-- changed from section to class_id
    ...
    $gender = $_POST['gender'];
    $class_id = $_POST['class_id']; // <-- changed from section to class_id
    ...
    if (empty($fname)) {
        ...
        $sql = "UPDATE students SET
                username = ?, fname=?, lname=?, grade=?, address=?, gender = ?, class_id=?, email_address=?, date_of_birth=?, parent_fname=?, parent_lname=?, parent_phone_number=?
                WHERE student_id=?";
        $stmt = $conn->prepare($sql);
        $stmt->execute([$uname, $fname, $lname, $grade, $address, $gender, $class_id, $email_address, $date_of_birth, $parent_fname, $parent_lname, $parent_phone_number, $student_id]);
